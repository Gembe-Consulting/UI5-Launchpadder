	...
	var URLShorter =  function() {
        ...
        * @private
        ...
        this.compactHash = function (sUrl, aRetainParameterList, oStoreContext) {
            ...
            // decompose the URL
            oUrlParsing = URLParser.getInstance();
        ...
        */
        this.expandParamGivenRetrievalFunction = function (sUrl, sParamName, fRetrieveValue) {
            ...
            // decompose the URL
            segments = URLParser.getInstance().parseShellHash(sUrl);
            ...
            return prependHash + URLParser.getInstance().constructShellHash(
                {
                    target : {
        ...
        this._blendParameters = function (oParams, sParamName, sValue) {
            var newParams = URLParser.getInstance().parseParameters("?" + sValue),
                a;
